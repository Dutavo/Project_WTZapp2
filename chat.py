...
def main(pagina): # criar a função principal/main
    ...
    # interações para com a mensagem
    ...
    titulo_popup = ft.Text("Bem vindo ao WTZapp2")
    nome_usuario = ft.TextField(label="Escreva seu nome no chat", on_submit=entrar_chat) # TextField -> Campo onde pode escrever
